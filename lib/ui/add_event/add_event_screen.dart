...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  String selectedCategoryId = EventCategories.bookClub.id;
  ...
  Future<void> addEvent() async {
    ...
    if (selectedDate == null) {
      showMessage('Please choose event date');
      return;
    }

    if (selectedTime == null) {
      showMessage('Please choose event time');
      return;
    }
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              _Header(
                title: provider.isEn ? 'Add event' : 'إضافة فعالية',
              ),
              ...
              FilledButton(
                ...
                child: isLoading
                  ...
                  child: CircularProgressIndicator(strokeWidth: 2),
                    ...
                    : Text(
                  provider.isEn ? 'Add event' : 'إضافة فعالية',
